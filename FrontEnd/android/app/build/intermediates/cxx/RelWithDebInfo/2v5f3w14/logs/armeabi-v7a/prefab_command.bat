...
"C:\\Program Files\\Microsoft\\jdk-17.0.13.11-hotspot\\bin\\java" ^
  ...
  26 ^
  --output ^
  "C:\\Users\\kosti\\AppData\\Local\\Temp\\agp-prefab-staging7088821161912995864\\staged-cli-output" ^
  ...
  "C:\\mts_app\\FrontEnd\\android\\app\\build\\intermediates\\cxx\\refs\\react-native-reanimated\\2j233p4z" ^
