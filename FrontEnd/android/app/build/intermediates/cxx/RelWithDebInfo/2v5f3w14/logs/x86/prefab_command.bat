...
"C:\\Program Files\\Microsoft\\jdk-17.0.13.11-hotspot\\bin\\java" ^
  ...
  26 ^
  --output ^
  "C:\\Users\\kosti\\AppData\\Local\\Temp\\agp-prefab-staging1891354508302824882\\staged-cli-output" ^
  ...
  "C:\\mts_app\\FrontEnd\\android\\app\\build\\intermediates\\cxx\\refs\\react-native-reanimated\\4q3y633d" ^
